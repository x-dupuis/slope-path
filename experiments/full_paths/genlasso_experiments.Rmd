...
We construct the matrix $D$ for the generalized LASSO for which 
$\|Db\|_1=6|b|_{\downarrow 1}+4|b|_{\downarrow2}+
2|b|_{\downarrow 3}$.
...
Actually $6$ and $5$ are true kinks of the OSCAR solution path but other kinks $8.75, 7.92, 6.87, 6.75, 6.42, 6.17, 0.0001$ are not relevant. Moreover some true kinks are missing: 
$3.75, 0.42,\dots$. 
...
Hereafter we standardize these data. 
...
We construct the matrix $D$ for the generalized LASSO for which 
$\|Db\|_1=4|b|_{\downarrow 1}+\dots+|b|_{\downarrow 11}$.
